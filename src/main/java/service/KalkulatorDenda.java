...
public class KalkulatorDenda {
    ...
    private static final double TARIF_DENDA_UMUM = 3500.0; // Diperbaiki dari 1500 ke 3500

    // Batas maksimal denda
    private static final double DENDA_MAX_MAHASISWA = 50000.0;
    private static final double DENDA_MAX_DOSEN = 70000.0;
    private static final double DENDA_MAX_UMUM = 100000.0; // Diperbaiki dari 15000 ke 100000
    ...
    public double hitungDenda(Peminjaman peminjaman, Anggota anggota) {
        ...
        double dendaMaksimal = getDendaMaksimal(anggota.getTipeAnggota());

        return Math.min(totalDenda, dendaMaksimal);
    }
